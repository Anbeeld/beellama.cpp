...
- **Independent draft micro-batch sizing**: MTP, DFlash, and other drafters get their own micro-batch size setting, `-ubd`, which defaults to 128. This saves gigabytes of memory (especially with DFlash) with no performance loss.
