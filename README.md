...
- **Independent draft ubatch sizing**: model-backed draft contexts inherit the target logical batch size and can use a smaller physical ubatch with `--spec-draft-ubatch-size`.
