...
TYPES_MMQ = [
    "GGML_TYPE_Q1_0",
    "GGML_TYPE_Q2_0", "GGML_TYPE_Q2_1", "GGML_TYPE_Q3_0", "GGML_TYPE_Q3_1",
...
# Turbo MMA fused kernel instances: straight TurboQuant matched K/V at D=128 and D=256.
TURBO_TYPES = [
...
for bits_k in KVARN_DECODE_BITS:
    for bits_v in KVARN_DECODE_BITS:
        ...
        with open(f"fattn-mma-kvarn-decode-instance-k{bits_k}-v{bits_v}.cu", "w") as f:
            f.write(SOURCE_FATTN_MMA_KVARN_DECODE.format(cases=cases))
